...
export function reportHtml(lead, s, { forInbox = false } = {}) {
  ...
  <div style="max-width:560px;margin:0 auto;padding:28px;background:#f7f8f3;color:#16211b;font-family:Georgia,serif">
    ...
    <p style="font-size:16px;line-height:1.65;color:#333">Water, then access, then structures, then plants. Planting first is the most common
    and most expensive mistake on Alberta acreages — the trees go in, and three years later the driveway or the
