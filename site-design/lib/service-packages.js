      ...
      packages.push(
        packageRec(tier.id, {
          ...
          price: {
            ...
            currency: 'CAD',
            label: `${tier.name} solar + ${tier.generator ? 'generator' : 'no generator'}`,
